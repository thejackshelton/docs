...
> When adding a folder inside of Storyblok, make sure that you update it in your get request to the Storyblok API. For example, if your stories are inside the blog folder, then you would have the prefix **cdn/stories/blog/**.
